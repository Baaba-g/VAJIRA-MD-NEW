...
global.owner = process.env.OWNER_NUMBER  || '923046123264' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID |VAJIRA-MD=uBMBgaYS#evumCOugeHOttafDeG1mudpXG20aSpTsHRelooZ-x0o| ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'IMRAN SALARA' ,
